...
# Title
st.title(':yellow[Youtube Data Harvesting]')
...
st.write ('(Note:- The role of this zone **collects data** from channel id  and ** get stored it in the :green[MongoDB] database**.)')
...
Get_data = st.button('**Get stored data**')
...
if Get_data or st.session_state.Get_state:
    ...
    api_version = 'v3'
    api_key = 'AIzaSyApTbjRQGTMv0wN3fwhnicLRnhBf8hZ6WI'
...
# ========================================   /     Data Migrate  (Stored data to MySQL)    /   ========================================== #


st.header(':blue[Data Migrate ]')
st.write ('''(Note:- The role of this zone specific channel data **Migrate to :blue[MySQL] database from  :green[MongoDB] database** depending on user selection,
...
st.write ('''(Note:- The role of this zone is**Analysis of a collection of channel data** depends on your question selection and gives output in table format.)''')
